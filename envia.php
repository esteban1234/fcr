...
//To address and name
$mail->addAddress("info@globalsolutionfcr.com");



$mail->isHTML(true);

$mail->Subject = "Cotización GLOBAL SOLUTION FCR";
$mail->Body = "
              <!DOCTYPE html>
                <html>
                <head>
                ...
                <h1 style='text-align:center;  font-weight: bold'> GLOBAL SOLUTION FCR</h1>
